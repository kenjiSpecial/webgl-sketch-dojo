...
var sunPosition = new THREE.Vector3( 0, 0, -200 );
...
function init(){
    ...
    boxMesh = new THREE.Mesh( geometry, new THREE.MeshLambertMaterial( { color: 0xff0000 } ) );
...
function render() {
    ...
    sunPosition.x += ( mouseX- sunPosition.x ) * 0.05;// * 0.036;
    sunPosition.y += ( -mouseY - sunPosition.y)* 0.05; //( mouseY - window.innerHeight/2 );
